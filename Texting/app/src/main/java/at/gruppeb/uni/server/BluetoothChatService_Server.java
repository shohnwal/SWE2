...
public class BluetoothChatService_Server {
     ...
     */
    public BluetoothChatService_Server(Context context, Handler handler) {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BluetoothChat_Server.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(BluetoothChat_Server.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothChat_Server.DEVICE_NAME, device.getName());
        msg.setData(bundle);
     ...
     * @see BluetoothChatService_Server.ConnectedThread#write(byte[])
     */
    ...
    private void connectionLost() {
        ...
        // Send a failure message back to the Activity
        Message msg = mHandler.obtainMessage(BluetoothChat_Server.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothChat_Server.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                BluetoothChatService_Server.this.start();
                return;
            }

            // Reset the ConnectThread because we're done
            synchronized (BluetoothChatService_Server.this) {
                mConnectThread = null;
            }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(BluetoothChat_Server.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BluetoothChat_Server.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
